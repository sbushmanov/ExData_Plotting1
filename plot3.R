##############################################################################
# 
# 1. This is a standalone file to produce Plot 3 from Assignment 1
...
# Step 5. Make plot 3 on screen
plot(x = plottingDataSubset$DateTime,
     y = plottingDataSubset$Sub_metering_1,
     type="n",
     xlab="",
     ylab="Energy sub metering")

lines(x=plottingDataSubset$DateTime,
     y=plottingDataSubset$Sub_metering_1,
     col="black")

lines(x=plottingDataSubset$DateTime,
      y=plottingDataSubset$Sub_metering_2,
      col="red")

lines(x=plottingDataSubset$DateTime,
      y=plottingDataSubset$Sub_metering_3,
      col="blue")
